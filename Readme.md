...
## 2.7 Servidor
O servidor é responsável por receber os dados dos sensores e armazena-los em um buffer dentro do servidor, além disso tem o papel de tratar as requisições (requests) da aplicação, por meio de fazer o processamento devido das informações e enviar a resposta adequada para cada solicitação.
